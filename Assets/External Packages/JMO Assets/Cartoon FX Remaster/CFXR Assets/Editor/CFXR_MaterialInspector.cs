...
namespace CartoonFX
{
    public class MaterialInspector : ShaderGUI
    {
        ...
        public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
        {
            ...
            for (var i = 0; i < properties.Length; i++)
            {
                ...
                {
                    for (var j = 0; j < guiCommands[i].Count; j++)
                    {
            ...
            {
                for (var j = 0; j < guiCommands[index].Count; j++)
                {
                    ...
                    foreach (string l in lines)
                    {
                        ...
                        if (insideProperties)
                        {
                            ...
                            if (line.StartsWith(kGuiCommandPrefix))
                            {
                                ...
                                {
                                    string expr = command.Substring(command.LastIndexOf(kGC_IfKeyword) +
                                ...
                                {
                                    string expr = command.Substring(command.LastIndexOf(kGC_IfProperty) +
                                ...
                                else if (command.StartsWith(kGC_HelpBox))
                                {
                                    ...
                                    else if (cmd.Length == 2)
                                    {
                                        ...
                                        {
                                            var msgType =
                                                (MessageType)System.Enum.Parse(typeof(MessageType), cmd[0], true);
                                ...
                                {
                                    string label =
                                        command.Substring(command.LastIndexOf(kGC_Label) + kGC_Label.Length + 1);
    ...
    internal class MaterialKeywordEnumNoPrefixDrawer : MaterialPropertyDrawer
    {
        ...
        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2) : this(
            new[] { lbl1, lbl2 }, new[] { kw1, kw2 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
            string kw3) : this(new[] { lbl1, lbl2, lbl3 }, new[] { kw1, kw2, kw3 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
            string kw3, string lbl4,
            string kw4) : this(new[] { lbl1, lbl2, lbl3, lbl4 }, new[] { kw1, kw2, kw3, kw4 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
            string kw3, string lbl4, string kw4, string lbl5, string kw5) : this(new[] { lbl1, lbl2, lbl3, lbl4, lbl5 },
            new[] { kw1, kw2, kw3, kw4, kw5 }) { }

        public MaterialKeywordEnumNoPrefixDrawer(string lbl1, string kw1, string lbl2, string kw2, string lbl3,
            string kw3, string lbl4, string kw4, string lbl5, string kw5, string lbl6, string kw6) : this(
            new[] { lbl1, lbl2, lbl3, lbl4, lbl5, lbl6 }, new[] { kw1, kw2, kw3, kw4, kw5, kw6 }) { }
    ...
    internal class GC_EndIf : GUICommand
    {
        ...
        public override void OnGUI()
        {
            MaterialInspector.PopShowProperty();
        }
